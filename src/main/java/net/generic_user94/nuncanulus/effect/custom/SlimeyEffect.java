package net.generic_user94.nuncanulus.effect.custom;
...
public class SlimeyEffect extends MobEffect {
    ...
    // THIS IS NOT MY CODE IT IS FROM THIS TUTORIAL https://www.youtube.com/playlist?list=PLKGarocXCE1G6CQOoiYdMVx-E1d9F_itF
